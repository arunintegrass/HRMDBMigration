	...
	//For Company Module
		...
		$subTableArray  =   array(								
								...
								array(
										...
										['pKey'=>'project_id','fKey'=>'branche_id','tbName'=>'hrm_project_tb','extraCond'=>" and branch_data = 'IN' "],
										...
										['pKey'=>'leave_type_id','fKey'=>'branche_id','tbName'=>'hrm_leave_type_tb','extraCond'=>" and hrm_version = 'IN' "],
									),	
							);	
	}		
